class ReviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @review.save
        format.html { redirect_to profile_reviews_path, notice: 'Review was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @review.update(review_params)
        format.html { redirect_to profile_reviews_path, notice: 'Review was successfully updated.' }
